...
Por medio de la presente se acuerda con el \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'' y consistirá en la implementación de un prototipo de un sistema de transmisión y recepción de audio. El trabajo tendrá un presupuesto preliminar estimado de 620 horas y un costo estimado de USD \$ 7.455, con fecha de inicio el \fechaInicioName\hspace{1px} y fecha de presentación pública el \fechaFinalName.
...
El camino crítico, resaltado en color negro y con un grosor más grande, posee una duración total estimada de 451 horas.
...
\begin{itemize}
	\item Severidad (S): 8 \\
	RTP es el mecanismo principal de transporte de audio del sistema, el retraso en su implementación afectaría el cumplimiento de las funciones críticas de transmisión y recepción de audio.
	\item Probabilidad de ocurrencia (O):  7 \\
...
\begin{itemize}
	\item Severidad (S): 7 \\
	La incapacidad para establecer una comunicación a través de mTLS limitá la seguridad del sistema ante terceros al no disponer de un mecanismo de validación en la red MQTT.
	\item Probabilidad de ocurrencia (O): 5 \\
	Pueden existir limitaciones en cuanto a poder de cómputo para gestionar, validar y actualizar los certificados CA para lograr la implementación de mTLS.
\end{itemize}
...
\begin{itemize}
	\item Severidad (S): 8 \\
	El dispositivo podría no soportar simultáneamente la captura y transmisión de audio, comunicación por MQTT y mTLS.
...
\begin{itemize}
	...
	La planificación considera 20 horas de trabajo semanalmente, durante un aproximado de 8 meses, por lo que cualquier imprevisto personal o laboral puede afectar el avance del proyecto. 
\end{itemize}
...
\begin{itemize}
	\item Severidad (S*): 7 \\
	La severidad se mantiene igual debido a que solo hay una persona encargada del desarrollo, integración, validación y documentación del proyecto.
...
\begin{itemize} 
	...
	\begin{itemize}
		...
		\item Validación: reproducir una señal de audio conocida y verificar mediante evaluación auditiva que el sonido es emitido correctamente por el parlante.
	\end{itemize}
	
	\item Req \#1.6. Configurar los parámetros de operación a través de MQTT.
	\begin{itemize}
		\item Verificación: enviar mensajes MQTT de configuración y comprobar que los parámetros son almacenados correctamente en memoria persistente a través de registros.
	...
	\begin{itemize}
		\item Verificación: monitorear el uso de CPU y memoria en escenarios de máxima carga a través de las herramientas de debug de Zephyr RTOS.
	...
	\begin{itemize}
		...
		\item Validación: simular una pérdida temporal de conectividad durante una conversación y confirmar que el dispositivo puede retomar la conexión de manera automática y sin afectar la operación general.
	\end{itemize}
