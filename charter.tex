...
Por medio de la presente se acuerda con el \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'' y consistirá en la implementación de un prototipo de un sistema de transmisión y recepción de audio. El trabajo tendrá un presupuesto preliminar estimado de 600 horas y un costo estimado de USD \$ 7.235, con fecha de inicio el \fechaInicioName\hspace{1px} y fecha de presentación pública el \fechaFinalName.
...
El camino crítico, resaltado en color negro y con un grosor mas grande, posee una duración total estimada de 431 horas.
...
En la figura \ref{fig:GanttTable} se presenta la tabla del diagrama de Gantt, elaborado con base en los 5 grupos de actividades identificados en la sección \ref{sec:wbs}. La tabla muestra las fechas estimadas de inicio y finalización de cada etapa y se considera una dedicación semanal de 20 horas con un tiempo total de 8 meses (abril a diciembre).
...
\begin{figure}[htpb]
\centering 
\includegraphics[width=\textwidth]{./Figuras/ASP_1.png}
...
\begin{figure}[htpb]
\centering 
\includegraphics[width=\textwidth]{./Figuras/ASP_2.png}
...
\caption{Diagrama de Gantt. Tarea 5}
\label{fig:GanttBAr3}
\end{figure}
...
Imprevistos (10 \% de costos directos) &
  \multicolumn{1}{c|}{1} &
  \multicolumn{1}{c|}{ \$ 639} &
  \multicolumn{1}{c|}{ \$ 639} \\ \hline
\multicolumn{3}{|c|}{SUBTOTAL en USD} &
  \multicolumn{1}{c|}{\$ 849} \\ \hline
\rowcolor[HTML]{C0C0C0}
\multicolumn{3}{|c|}{TOTAL en USD} & 
	\multicolumn{1}{c|}{\$ 7.235} \\ \hline
\rowcolor[HTML]{C0C0C0}
\multicolumn{3}{|c|}{TOTAL en ARS} & 
	\multicolumn{1}{c|}{\$ 10.169.516} \\ \hline
\end{tabularx}%
...
realizará una reunión de cierre entre el responsable del proyecto y el director del Trabajo Final con el objetivo de evaluar el cumplimiento de los objetivos planteados, analizar los resultados obtenidos y documentar las lecciones aprendidas durante el desarrollo.
...
\begin{itemize}
	\item Pautas de trabajo que se seguirán para analizar si se respetó el P'lan de Proyecto original:\\
