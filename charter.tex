...
Por medio de la presente se acuerda con el \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'' y consistirá en la implementación de un prototipo de un sistema de transmisión y recepción de audio. El trabajo tendrá un presupuesto preliminar estimado de 600 horas y un costo estimado de \$ 7.235 USD, con fecha de inicio el \fechaInicioName\hspace{1px} y fecha de presentación pública el \fechaFinalName.
...
\begin{enumerate}
	...
	\item Preparación del entorno de desarrollo (70 h):
		\begin{enumerate}
			...
			\item Consulta requerimientos funcionales del protocolo RTP (8 h).
...
El camino crítico, resaltado en color negro, posee una duración total estimada de 431 horas.
...
En la figura \ref{fig:GanttTable} se presenta la tabla del diagrama de Gantt, elaborado con base en los 5 grupos de actividades identificados en la sección \ref{sec:wbs}. La tabla muestra las fechas estimadas de inicio y finalización de cada etapa y se considera una dedicación semanal de 20 horas con un tiempo total de 7 meses.
...
Microfono para captura de audio &
  \multicolumn{1}{c|}{1} &
  \multicolumn{1}{c|}{\$ 10} &
...
\multicolumn{3}{|c|}{TOTAL en ARS} & 
	\multicolumn{1}{c|}{\$ 10'169.545} \\ \hline
\end{tabularx}%
